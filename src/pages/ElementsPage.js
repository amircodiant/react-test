    ...
    <div className="subpage">
      ...
      <section id="main" className="wrapper">
        <div className="inner">
          ...
          <div className="row">
            <section className="6u 12u$(medium)">
              <h2>What is Baseline?</h2>
              <p>
                <strong>Baseline</strong>
                {' '}
is a simple boilerplate for creating new projects with
                {' '}
                <a href="http://skel.io">Skel</a>
. It features clear, concise HTML5 and CSS3 code
                (built on
                <a href="http://sass-lang.com">Sass</a>
), responsiveness right out of the
                box, off-canvas navigation, an assortment of pre-styled elements,
                {' '}
                <a href="http://fontawesome.io">Font Awesome</a>
                {' '}
icons, and everything offered by
                Skel + Skel.scss. Baseline is
...
.
            ...
            <section className="3u 6u(medium) 12u$(small)">
              <h3>Sed Feugiat</h3>
              <p>
                Erat ac non lorem justo amet primis dolor adipiscing lacinia accumsan felis sed
                dolor interdum ut. Amet accumsan magna etiam orci faucibus interdum et lorem ipsum
                et nullam.
              </p>
            </section>
            <section className="3u$ 6u$(medium) 12u$(small)">
          ...
          <p>
            ...
            accumsan vivamus ac blandit adipiscing adipiscing arcu metus praesent turpis eu ac
            lacinia nunc ac commodo gravida adipiscing eget accumsan ac nunc adipiscing adipiscing.
          </p>
          <div className="row">
            <div className="6u 12u$(small)">
              ...
              <p>
                ...
                non mi integer non faucibus ornare mi ut ante amet placerat aliquet. Volutpat
                commodo eu sed ante lacinia. Sapien a lorem in integer ornare praesent commodo
                adipiscing arcu in massa commodo lorem accumsan at odio massa ac ac. Semper
            ...
            <div className="6u$ 12u$(small)">
              ...
              <p>
                In arcu accumsan arcu adipiscing accumsan orci ac. Felis id enim aliquet. Accumsan
                ac integer lobortis commodo ornare aliquet accumsan erat tempus amet porttitor. Ante
                commodo blandit adipiscing integer semper orci eget. Faucibus commodo adipiscing mi
                eu nullam accumsan morbi arcu ornare odio mi adipiscing nascetur lacus ac interdum
...
.
            ...
            <div className="6u$ 12u$(medium)">
              ...
              <p>
                ...
                ipsum primis sagittis eget. tempus euismod. Vestibulum ante ipsum primis in faucibus
                ...
                praesent. Vestibulum ante ipsum primis in faucibus magna blandit adipiscing eu felis
