...
const skel = (function () {
  var t = {
    ...
    isInit: !1,
    obj: {
      attachments: {}, breakpoints: {}, head: null, states: {},
    },
    sd: '/',
    state: null,
    stateHandlers: {},
    ...
    newAttachment(e, n, i, a) {
      return (t.obj.attachments[e] = {
        id: e, element: n, priority: i, permanent: a,
      });
    },
    init() {
      t.initMethods(),
    ...
    initMethods() {
      ...
      Array.prototype.indexOf
        ...
        : (t.indexOf = function (t, e) {
          ...
          for (a < 0 && (a = i - Math.abs(a)), n = a; i > n; n++) if (this[n] === t) return n;
          return -1;
        }),
      Array.isArray
        ...
        : window.styleMedia || window.media
          ...
          : window.getComputedStyle
            ? (t.matchesMedia = function (t) {
              ...
              (i = ('getComputedStyle' in window && window.getComputedStyle(e, null))
                  || e.currentStyle);
              const a = `@media ${t}{ #matchmediajs-test { width: 1px; } }`;
              return (
                e.styleSheet ? (e.styleSheet.cssText = a) : (e.textContent = a), i.width === '1px'
              );
            })
            : (t.matchesMedia = function (t) {
              if (t == '') return !0;
              ...
              const r = { 'min-width': null, 'max-width': null };
              ...
              return (r['min-width'] !== null && s < r['min-width'])
                || (r['max-width'] !== null && s > r['max-width'])
                || (r['min-height'] !== null && c < r['min-height'])
                || (r['max-height'] !== null && c > r['max-height'])
                ? !1
                : !0;
            }),
    ...
    initVars() {
      ...
      t.iterate(i, (t, i) => (a.match(i[1]) ? ((e = i[0]), (n = parseFloat(RegExp.$1)), !1) : void 0)),
      (t.vars.browser = e),
