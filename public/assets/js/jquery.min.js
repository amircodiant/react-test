...
!(function (a, b) {
  ...
  m.extend({
    ...
    makeArray(a, b) {
      const c = b || [];
      return (
        a != null && (r(Object(a)) ? m.merge(c, typeof a === 'string' ? [a] : a) : f.call(c, a)), c
      );
    },
    inArray(a, b, c) {
      let d;
      if (b) {
        ...
        for (d = b.length, c = c ? (c < 0 ? Math.max(0, d + c) : c) : 0; d > c; c++) if (c in b && b[c] === a) return c;
      }
      return -1;
    },
    merge(a, b) {
  ...
  const s = (function (a) {
    ...
    function ga(a, b, d, e) {
      let f; let h; let j; let k; let l; let o; let r; let s; let w; let
        x;
      if (
    ...
    (m = ga.setDocument = function (a) {
      ...
      return g !== n && g.nodeType === 9 && g.documentElement
        ...
        (c.getElementsByTagName = ja(a => a.appendChild(g.createComment('')), !a.getElementsByTagName('*').length)),
        ...
        (B = b
          ? function (a, b) {
            ...
            return d || ((d = (a.ownerDocument || a) === (b.ownerDocument || b)
    ...
    function va(a, b, c, d, e) {
      for (var f, g = [], h = 0, i = a.length, j = b != null; i > h; h++) (f = a[h]) && (!c || c(f, d, e)) && (g.push(f), j && b.push(h));
      return g;
    }
    ...
    return (
      ...
      m(),
      (c.sortDetached = ja(a => 1 & a.compareDocumentPosition(n.createElement('div')))),
      ja(a => (a.innerHTML = "<a href='#'></a>"), a.firstChild.getAttribute('href') === '#')
        || ka('type|href|height|width', (a, b, c) => (c ? void 0 : a.getAttribute(b, b.toLowerCase() === 'type' ? 1 : 2))),
      (c.attributes
        && ja(a => (
          (a.innerHTML = '<input/>'),
        ...
        || ka('value', (a, b, c) => (c || a.nodeName.toLowerCase() !== 'input' ? void 0 : a.defaultValue)),
  ...
  const A = (m.fn.init = function (a, b) {
    ...
    if (typeof a === 'string') {
      if (
        ((c = a.charAt(0) === '<' && a.charAt(a.length - 1) === '>' && a.length >= 3
          ? [null, a, null]
          : z.exec(a)),
        !c || (!c[1] && b))
  ...
  m.extend({
    dir(a, b, c) {
      ...
      let e = a[b];
      while (e && e.nodeType !== 9 && (void 0 === c || e.nodeType !== 1 || !m(e).is(c))) e.nodeType === 1 && d.push(e), (e = e[b]);
      return d;
    },
    sibling(a, b) {
    ...
    closest(a, b) {
      for (
        ...
        for (c = this[d]; c && c !== b; c = c.parentNode) {
          if (
            c.nodeType < 11
              && (g ? g.index(c) > -1 : c.nodeType === 1 && m.find.matchesSelector(c, a))
          ) {
            f.push(c);
            break;
          }
  ...
  function J() {
    (y.addEventListener || event.type === 'load' || y.readyState === 'complete')
      && (I(), m.ready());
  }
  ...
  function P(a) {
    let b;
    for (b in a) if ((b !== 'data' || !m.isEmptyObject(a[b])) && b !== 'toJSON') return !1;
    ...
    if (m.acceptData(a)) {
      ...
      if ((k && j[k] && (e || j[k].data)) || void 0 !== d || typeof b !== 'string') {
        return (
          ...
          typeof b === 'string' ? ((f = g[b]), f == null && (f = g[m.camelCase(b)])) : (f = g),
          f
        );
      }
    }
  ...
  m.fn.extend({
    data(a, b) {
      ...
      if (void 0 === a) {
        if (this.length && ((e = m.data(f)), f.nodeType === 1 && !m._data(f, 'parsedAttrs'))) {
          c = g.length;
          while (c--) {
            g[c]
                && ((d = g[c].name),
                d.indexOf('data-') === 0 && ((d = m.camelCase(d.slice(5))), O(f, d, e[d])));
          }
        ...
        arguments.length < c
          ...
          : void 0 === b
            ...
            : this.each(function () {
              ...
              m._queueHooks(this, a), a === 'fx' && c[0] !== 'inprogress' && m.dequeue(this, a);
            })
      );
    },
    dequeue(a) {
  ...
  !(function () {
    ...
    if (
      ...
      (k.html5Clone = y.createElement('nav').cloneNode(!0).outerHTML !== '<:nav></:nav>'),
      (a.type = 'checkbox'),
      (a.checked = !0),
      c.appendChild(a),
  ...
  (m.event = {
    ...
    special: {
      ...
      click: {
        trigger() {
          return m.nodeName(this, 'input') && this.type === 'checkbox' && this.click
            ? (this.click(), !1)
            : void 0;
        },
        _default(a) {
    ...
    simulate(a, b, c, d) {
      const e = m.extend(new m.Event(), c, { type: a, isSimulated: !0, originalEvent: {} });
      ...
      || (m.event.special.submit = {
        setup() {
          return m.nodeName(this, 'form')
            ? !1
            : void m.event.add(this, 'click._submit keypress._submit', (a) => {
              const b = a.target;
              ...
              c
                  ...
                  && (m.event.add(c, 'submit._submit', (a) => {
                    a._submit_bubble = !0;
                  }),
      ...
      || (m.event.special.change = {
        setup() {
          return X.test(this.nodeName)
            ...
            !1)
            : void m.event.add(this, 'beforeactivate._change', (a) => {
              const b = a.target;
              X.test(b.nodeName)
  ...
  k.focusinBubbles
      || m.each({ focus: 'focusin', blur: 'focusout' }, (a, b) => {
        const c = function (a) {
  ...
  function ua(a, b) {
    ...
    let f = typeof a.getElementsByTagName !== K
      ? a.getElementsByTagName(b || '*')
      : typeof a.querySelectorAll !== K
        ? a.querySelectorAll(b || '*')
        : void 0;
    if (!f) for (f = [], c = a.childNodes || a; (d = c[e]) != null; e++) !b || m.nodeName(d, b) ? f.push(d) : m.merge(f, ua(d, b));
  ...
  function wa(a, b) {
    return m.nodeName(a, 'table') && m.nodeName(b.nodeType !== 11 ? b : b.firstChild, 'tr')
  ...
  function za(a, b) {
    for (var c, d = 0; (c = a[d]) != null; d++) m._data(c, 'globalEval', !b || m._data(b[d], 'globalEval'));
  }
  function Aa(a, b) {
  ...
  m.extend({
    clone(a, b, c) {
      ...
      const i = m.contains(a.ownerDocument, a);
      if (
      ...
      ) for (d = ua(f), h = ua(a), g = 0; (e = h[g]) != null; ++g) d[g] && Ba(e, d[g]);
      if (b) {
        if (c) for (h = h || ua(a), d = d || ua(f), g = 0; (e = h[g]) != null; g++) Aa(e, d[g]);
        else Aa(a, f);
      }
      return (
  ...
  m.fn.extend({
    ...
    remove(a, b) {
      for (var c, d = a ? m.filter(a, this) : this, e = 0; (c = d[e]) != null; e++) {
    ...
    html(a) {
      return V(
        ...
        function (a) {
          ...
          const d = this.length;
          if (void 0 === a) return b.nodeType === 1 ? b.innerHTML.replace(fa, '') : void 0;
          if (
            !(
              typeof a !== 'string'
                || ma.test(a)
            ...
            try {
              for (; d > c; c++) {
                (b = this[c] || {}),
                b.nodeType === 1 && (m.cleanData(ua(b, !1)), (b.innerHTML = a));
              }
              b = 0;
            } catch (e) {}
          }
  ...
  function Ea(b, c) {
    ...
    const f = a.getDefaultComputedStyle && (d = a.getDefaultComputedStyle(e[0]))
      ? d.display
      : m.css(e[0], 'display');
    return e.detach(), f;
  }
  ...
  const Ka = /^(top|right|bottom|left)$/;
  a.getComputedStyle
    ? ((Ia = function (b) {
  ...
  !(function () {
    let b; let c; let d; let e; let f; let g; let
      h;
    if (
      ((b = y.createElement('div')),
      (b.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>"),
      ...
      function i() {
        ...
        c
            ...
            a.getComputedStyle
              ...
              (f = (a.getComputedStyle(b, null) || { width: '4px' }).width === '4px'),
  ...
  const Ra = { position: 'absolute', visibility: 'hidden', display: 'block' };


  const Sa = { letterSpacing: '0', fontWeight: '400' };
  ...
  function Xa(a, b, c, d, e) {
    for (var f = c === (d ? 'border' : 'content') ? 4 : b === 'width' ? 1 : 0, g = 0; f < 4; f += 2) {
      ...
      d
        ...
        c !== 'padding' && (g += m.css(a, `border${T[f]}Width`, !0, e)));
    }
    return g;
  }
  function Ya(a, b, c) {
      ...
      if (a && a.nodeType !== 3 && a.nodeType !== 8 && a.style) {
        ...
        if (
          ...
          c != null
            ...
            k.clearCloneStyle || c !== '' || b.indexOf('background') !== 0 || (i[b] = 'inherit'),
    ...
    m.cssHooks[b] = {
      ...
      set(a, c, d) {
        ...
        return Wa(
          a,
          c,
          d ? Xa(a, b, d, k.boxSizing && m.css(a, 'boxSizing', !1, e) === 'border-box', e) : 0,
        );
      },
    };
  }),
  ...
  (m.cssHooks.marginRight = La(k.reliableMarginRight, (a, b) => (b ? m.swap(a, { display: 'inline-block' }, Ja, [a, 'marginRight']) : void 0))),
  m.each({ margin: '', padding: '', border: 'Width' }, (a, b) => {
    (m.cssHooks[a + b] = {
      expand(c) {
        for (var d = 0, e = {}, f = typeof c === 'string' ? c.split(' ') : [c]; d < 4; d++) e[a + T[d] + b] = f[d] || f[d - 2] || f[0];
        return e;
      },
    }),
  ...
  (Za.prototype = {
    ...
    run(a) {
      ...
      const c = Za.propHooks[this.prop];
      return (
  ...
  (Za.propHooks = {
    _default: {
      ...
      set(a) {
        m.fx.step[a.prop]
          ? m.fx.step[a.prop](a)
          : a.elem.style && (a.elem.style[m.cssProps[a.prop]] != null || m.cssHooks[a.prop])
        ...
        if (e) {
          return (
            ...
            b && 'get' in b && void 0 !== (c = b.get(e, 'value'))
              ? c
              : ((c = e.value), typeof c === 'string' ? c.replace(lb, '') : c == null ? '' : c)
          );
        }
      }
    },
        ...
        get(a) {
          for (
            ...
            if (
              ...
              !(
                (!c.selected && i !== e)
                  || (k.optDisabled ? c.disabled : c.getAttribute('disabled') !== null)
  ...
  (m.parseJSON = function (b) {
    ...
    return e
      && !m.trim(
        e.replace(xb, (a, b, e, f) => c && b && (d = 0), d === 0 ? a : ((c = e || b), (d += !f - !e), '')),
      )
      ? Function(`return ${e}`)()
      ...
      return this.map(function () {
        ...
        .map(function (a, b) {
          ...
          return c == null
            ? null
            : m.isArray(c)
              ? m.map(c, a => ({ name: b.name, value: a.replace(Sb, '\r\n') }))
            ...
            send(c, d) {
              ...
              (b = function (c, e) {
                ...
                if (b && (e || f.readyState === 4)) {
                  if ((delete Xb[g], (b = void 0), (f.onreadystatechange = m.noop), e)) f.readyState !== 4 && f.abort();
                  else {
                    (j = {}),
                    (h = f.status),
  ...
  (m.fn.load = function (a, b, c) {
    ...
    return (
      ...
      m.isFunction(b) ? ((c = b), (b = void 0)) : b && typeof b === 'object' && (f = 'POST'),
      g.length > 0
        && m
          .ajax({
  ...
  m.fn.extend({
    ...
    offsetParent() {
      return this.map(function () {
        ...
        while (a && !m.nodeName(a, 'html') && m.css(a, 'position') === 'static') a = a.offsetParent;
        return a || cc;
      });
    },
  }),
  m.each({ scrollLeft: 'pageXOffset', scrollTop: 'pageYOffset' }, (a, b) => {
    const c = /Y/.test(b);
    m.fn[a] = function (d) {
      return V(
        this,
  ...
  m.each(['top', 'left'], (a, b) => {
    m.cssHooks[b] = La(k.pixelPosition, (a, c) => (c ? ((c = Ja(a, b)), Ha.test(c) ? `${m(a).position()[b]}px` : c) : void 0));
  }),
  m.each({ Height: 'height', Width: 'width' }, (a, b) => {
    m.each({ padding: `inner${a}`, content: b, '': `outer${a}` }, (c, d) => {
      m.fn[d] = function (d, e) {
